/datum/gear/factionsecurity
	...
	allowed_roles = list("Black Guard Commander","Lieutenant","Desk Sergeant","Sergeant Major","Corpsman","Black Guard Trooper","Police Officer")
	slot = slot_wear_suit
...
/datum/gear/factionsecurity/beretcommander
	...
	allowed_roles = list("Black Guard Commander","Lieutenant")
	slot = slot_head
	sort_category = "Faction: Security"
...
/datum/gear/factionsecurity/beretwarden
	display_name = "beret, Desk Sergeant"
	path = /obj/item/clothing/head/rank/warden/beret
	allowed_roles = list("Desk Sergeant","Sergeant Major")
	slot = slot_head
	sort_category = "Faction: Security"

/datum/gear/factionsecurity/cloak
	display_name = "cloak, Lieutenant"
...
/datum/gear/factionsecurity/capsarge
	display_name = "cap, Desk Sergeant"
...
/datum/gear/factionsecurity/jumpskirtoperative
	...
	allowed_roles = list("Desk Sergeant","Sergeant Major","Corpsman","Black Guard Trooper","Police Officer")
	slot = slot_w_uniform
	sort_category = "Faction: Security"

/datum/gear/factionsecurity/jumpskirtwarden
	display_name = "jumpskirt, Desk Sergeant"
	path = /obj/item/clothing/under/rank/warden/skirt
	allowed_roles = list("Desk Sergeant")
	slot = slot_w_uniform
	sort_category = "Faction: Security"
